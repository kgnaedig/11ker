...
function exp_reszekkorvonal_1rule0_eval_expression(context) {
    // var('id') = 2
...
function exp_reszekkorvonal_1rule1_eval_expression(context) {
    // var('id') = 5
...
function exp_reszekkorvonal_1rule2_eval_expression(context) {
    // var('id') = 4
...
function exp_reszekkorvonal_1rule3_eval_expression(context) {
    // var('id') = 8
...
function exp_reszekkorvonal_1rule4_eval_expression(context) {
    // var('id') = - 49
...
function exp_reszekkorvonal_1rule5_eval_expression(context) {
    // var('id') = 1
